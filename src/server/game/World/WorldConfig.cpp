...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<float>(RATE_CREATURE_LEVEL_1_4_DAMAGE, "Rate.Creature.Level.1-4.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_5_9_DAMAGE, "Rate.Creature.Level.5-9.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_10_14_DAMAGE, "Rate.Creature.Level.10-14.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_15_19_DAMAGE, "Rate.Creature.Level.15-19.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_20_24_DAMAGE, "Rate.Creature.Level.20-24.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_25_29_DAMAGE, "Rate.Creature.Level.25-29.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_30_34_DAMAGE, "Rate.Creature.Level.30-34.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_35_39_DAMAGE, "Rate.Creature.Level.35-39.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_40_44_DAMAGE, "Rate.Creature.Level.40-44.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_45_49_DAMAGE, "Rate.Creature.Level.45-49.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_50_54_DAMAGE, "Rate.Creature.Level.50-54.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_55_59_DAMAGE, "Rate.Creature.Level.55-59.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_60_DAMAGE, "Rate.Creature.Level.60.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_61_64_DAMAGE, "Rate.Creature.Level.61-64.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_65_69_DAMAGE, "Rate.Creature.Level.65-69.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_70_DAMAGE, "Rate.Creature.Level.70.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_71_74_DAMAGE, "Rate.Creature.Level.71-74.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_75_79_DAMAGE, "Rate.Creature.Level.75-79.Damage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_80_90_DAMAGE, "Rate.Creature.Level.80-90.Damage", 1.0f);
    ...
    // CUSTOM MODIFICATIONS
    SetConfigValue<float>(RATE_CREATURE_LEVEL_1_4_HP, "Rate.Creature.Level.1-4.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_5_9_HP, "Rate.Creature.Level.5-9.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_10_14_HP, "Rate.Creature.Level.10-14.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_15_19_HP, "Rate.Creature.Level.15-19.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_20_24_HP, "Rate.Creature.Level.20-24.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_25_29_HP, "Rate.Creature.Level.25-29.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_30_34_HP, "Rate.Creature.Level.30-34.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_35_39_HP, "Rate.Creature.Level.35-39.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_40_44_HP, "Rate.Creature.Level.40-44.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_45_49_HP, "Rate.Creature.Level.45-49.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_50_54_HP, "Rate.Creature.Level.50-54.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_55_59_HP, "Rate.Creature.Level.55-59.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_60_HP, "Rate.Creature.Level.60.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_61_64_HP, "Rate.Creature.Level.61-64.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_65_69_HP, "Rate.Creature.Level.65-69.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_70_HP, "Rate.Creature.Level.70.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_71_74_HP, "Rate.Creature.Level.71-74.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_75_79_HP, "Rate.Creature.Level.75-79.HP", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_80_90_HP, "Rate.Creature.Level.80-90.HP", 1.0f);
    // END CUSTOM MODIFICATIONS
    ...
    // CUSTOM MODIFICATIONS
    SetConfigValue<float>(RATE_CREATURE_LEVEL_1_4_SPELLDAMAGE, "Rate.Creature.Level.1-4.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_5_9_SPELLDAMAGE, "Rate.Creature.Level.5-9.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_10_14_SPELLDAMAGE, "Rate.Creature.Level.10-14.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_15_19_SPELLDAMAGE, "Rate.Creature.Level.15-19.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_20_24_SPELLDAMAGE, "Rate.Creature.Level.20-24.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_25_29_SPELLDAMAGE, "Rate.Creature.Level.25-29.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_30_34_SPELLDAMAGE, "Rate.Creature.Level.30-34.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_35_39_SPELLDAMAGE, "Rate.Creature.Level.35-39.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_40_44_SPELLDAMAGE, "Rate.Creature.Level.40-44.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_45_49_SPELLDAMAGE, "Rate.Creature.Level.45-49.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_50_54_SPELLDAMAGE, "Rate.Creature.Level.50-54.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_55_59_SPELLDAMAGE, "Rate.Creature.Level.55-59.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_60_SPELLDAMAGE, "Rate.Creature.Level.60.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_61_64_SPELLDAMAGE, "Rate.Creature.Level.61-64.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_65_69_SPELLDAMAGE, "Rate.Creature.Level.65-69.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_70_SPELLDAMAGE, "Rate.Creature.Level.70.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_71_74_SPELLDAMAGE, "Rate.Creature.Level.71-74.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_75_79_SPELLDAMAGE, "Rate.Creature.Level.75-79.SpellDamage", 1.0f);
    SetConfigValue<float>(RATE_CREATURE_LEVEL_80_90_SPELLDAMAGE, "Rate.Creature.Level.80-90.SpellDamage", 1.0f);
    // END CUSTOM MODIFICATIONS
